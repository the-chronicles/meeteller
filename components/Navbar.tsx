...
export const Navbar = () => {
  ...
  return (
    <nav className="pointer-events-none fixed top-0 left-0 z-50 mt-10 flex w-full justify-center">
      ...
      <div
        className={`pointer-events-auto flex h-16 w-[90%] items-center justify-between rounded-md px-8 py-9 transition-all duration-300 md:w-[70%] lg:w-[55%] ${
          scrolled
      ...
      >
        ...
        <div className="hidden items-center gap-6 text-[15px] md:flex">
          ...
          <Link
            href="/signup"
            className="rounded-md bg-[#5b09c4] px-4 py-2 text-white transition hover:bg-[#5b09c4]/90"
          >
            Get Started
          </Link>
        </div>
